    ...
    return (
        <main className="flex-grow w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 py-6 lg:py-10 animate-pulse">
            <div className="pt-5 lg:pt-5 mb-6">
                <div className="h-9 w-48 bg-slate-200 rounded-full" />
            </div>

            <div className="flex flex-col lg:flex-row gap-8 lg:gap-16">
                {/* Gallery Skeleton */}
                <div className="w-full flex flex-col lg:w-[40%]">
                    <div className="w-full aspect-[9/16] bg-slate-200 rounded-xl lg:rounded-2xl flex items-center justify-center">
                ...
                <div className="w-full lg:w-[60%]">
                    <div className="flex flex-col gap-6 lg:gap-8 bg-surface rounded-2xl lg:rounded-3xl p-6 lg:p-8 border border-gray-100">
                        {/* Badge + Status */}
                        <div className="flex flex-col gap-2 border-b border-gray-100 pb-6">
                            ...
                            <div className="h-10 w-3/4 bg-slate-200 rounded mt-2" />
                        ...
                        <div className="grid grid-cols-2 gap-3 lg:gap-4 lg:grid-cols-3">
                            {[1, 2, 3, 4].map(i => (
                                <div key={i} className="bg-background-light p-4 rounded-xl flex flex-col items-start gap-2">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="p-4 bg-background-light rounded-xl space-y-2">
